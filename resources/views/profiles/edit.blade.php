	  ...
	  <div class="row">
	    ...
	    <div class="col-md-4 col-sm-6 col-xs-12">
	      <div class="text-center">
			...
			{!! Form::open(['data-remote', 'method' => 'PATCH', 'url' => 'profiles/' . $profile->id . '/image', 'files' => true, 'class' => 'form-horizontal', 'role' => 'form']) !!}
	    ...
	    <div class="col-md-8 col-sm-6 col-xs-12 personal-info">
	      ...
	      {!! Form::open(['data-remote', 'method' => 'PATCH', 'url' => 'profiles/' . $profile->id, 'files' => true, 'class' => 'form-horizontal', 'role' => 'form']) !!}
	        ...
	        <div class="form-group">
	          ...
	          <div class="col-lg-8">
	          {!! Form::text('github', $profile->github, ['class' => 'form-control']) !!}
